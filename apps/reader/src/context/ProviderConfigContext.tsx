...
export type ProviderId = "openai" | "anthropic" | "google" | "deepseek" | "moonshot" | "custom";
...
const DEFAULT_LANES: Record<LaneId, LaneConfig> = {
  fast: { modelId: "gpt-4o-mini", providerId: "openai" },
  deep: { modelId: "gpt-4o", providerId: "openai" },
};
...
const DEFAULT_STATE: ProviderConfigState = {
  providers: {
    ...
    anthropic: createDefaultConfig("anthropic"),
...
export { DEFAULT_BASE_URLS, DEFAULT_PROVIDER_NAMES };
