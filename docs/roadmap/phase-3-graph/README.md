...
Status: Completed
Dependencies: docs/roadmap/phase-2-expansion (core completed; Track Q DX merge pending), Track L architecture, Track O A2A baseline, Track P state/memory baseline
...
- Runtime-backed CLI/TUI wiring with streaming and session resume (`docs/roadmap/phase-2-expansion/track-q-developer-experience.md`).
...
| --- | --- | --- | --- |
| S | Graph Execution Runtime | High | `docs/roadmap/phase-3-graph/track-s-graph-runtime.md` |
| T | Multi-Agent Teams and Protocols | High | `docs/roadmap/phase-3-graph/track-t-multi-agent-teams.md` |
| U | Tool Workbench and Policy | High | `docs/roadmap/phase-3-graph/track-u-tool-workbench-policy.md` |
| V | Workspace Time Travel | Medium | `docs/roadmap/phase-3-graph/track-v-workspace-time-travel.md` |
| W | Computer Use and Multimodal IO | Medium | `docs/roadmap/phase-3-graph/track-w-computer-use.md` |
