...
- Q3 Cognitive Layer: `docs/roadmap/next-q3/README.md`
- Q3 Acceptance Criteria: `docs/roadmap/next-q3/acceptance-criteria.md`
- Q2 Graph Runtime: `docs/roadmap/next-q2/track-s-graph-runtime.md`
- AI Envelope: `docs/roadmap/agent-runtime-2026-track-g-ai-envelope-lfcc.md`
- Design system tokens: `docs/roadmap/ui/track-2-components.md`
