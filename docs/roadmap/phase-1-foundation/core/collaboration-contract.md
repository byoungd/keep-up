...
- Roadmap and tracks: docs/roadmap/phase-1-foundation/core/roadmap-2026.md
- Cross-track contract freeze: docs/roadmap/ui-cowork/cowork-contract-freeze.md
...
2. Create feature branch: `git checkout -b feature/track-<track>`
