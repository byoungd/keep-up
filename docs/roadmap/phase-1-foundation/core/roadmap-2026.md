...
| Track | Status | Notes |
| --- | --- | --- |
| A-G | Completed | Core runtime contracts implemented and tested. |
| H | Completed | Optimization merged across runtime packages. |
| I-K | Completed | Cache, container pool, memory cache delivered. |
| L | Active | Execution plane + artifacts/checkpoint consolidation pending; facade partially wired. |
| M1-M5 | Completed (monolith) | Implemented in monolith; re-home after L1/L2 extraction. |
...
- Branch from latest main: `git checkout main && git pull` then create `feature/track-<track>`
- Implement tasks, run required tests, and document results
- Commit with clear message, open PR, request review

## Track Documents
- docs/roadmap/phase-1-foundation/core/track-a-completion-recovery.md
- docs/roadmap/phase-1-foundation/core/track-b-tool-governance.md
- docs/roadmap/phase-1-foundation/core/track-c-checkpoint-eventlog.md
- docs/roadmap/phase-1-foundation/core/track-d-delegation-messaging.md
- docs/roadmap/phase-1-foundation/core/track-e-sop-roles.md
- docs/roadmap/phase-1-foundation/core/track-f-model-routing-observability.md
- docs/roadmap/phase-1-foundation/core/track-g-ai-envelope-lfcc.md
- docs/roadmap/phase-1-foundation/core/track-h-optimization.md
- docs/roadmap/phase-1-foundation/core/track-i-lru-cache.md
- docs/roadmap/phase-1-foundation/core/track-j-docker-pooling.md
- docs/roadmap/phase-1-foundation/core/track-k-memory-cache.md
