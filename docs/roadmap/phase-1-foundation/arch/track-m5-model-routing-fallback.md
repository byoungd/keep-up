...
- Health tracker and fallback logic live in `packages/agent-runtime/src/routing`.
- Routing decisions include health/fallback metrics and telemetry hooks.
...
- Create branch: `feature/track-m5-model-routing-fallback`
