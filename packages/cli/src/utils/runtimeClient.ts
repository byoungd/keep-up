...
import type { SessionMessage } from "@ku0/tooling-session";
...
function resolveProviderSelection(providerOverride?: string) {
...
function toAICoreResponse(response: CompletionResponse): AICoreProviderResponse {
  return {
