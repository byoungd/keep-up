...
export function ArtifactView({ item }: { item: ArtifactItem }) {
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 bg-surface-1 h-full">
      ...
      {/* Content */}
      <div className="flex-1 overflow-y-auto p-6 bg-surface-2/5 relative">
        {item.type === "image" ? (
          ...
          /* Doc / Text Preview */
          <div className="w-full max-w-3xl mx-auto bg-surface-1 border border-border/10 rounded-xl p-8 shadow-sm h-full overflow-y-auto">
            {item.content ? (
  ...
  return (
    ...
    >
      <div className="flex flex-1 h-full min-h-0">
        ...
        {items.length > 1 && (
          <div className="w-64 border-r border-border/10 bg-surface-2/10 flex flex-col overflow-y-auto">
